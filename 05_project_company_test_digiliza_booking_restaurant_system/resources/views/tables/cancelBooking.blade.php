<x-app-layout>
	...
	<div class="py-6">
		<div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
          ...
          <h2 class="font-semibold text-xl text-gray-800 leading-tight" style=" margin-bottom:20px;">Cancel a Booking for {{ $bookingDateString }}</h2>
    
          <form action="{{ route('tables.cancelBookingPut') }}" method="post">
            @method('put')
            @csrf
            ...
            <x-button class="mt-2" style=" margin-bottom:20px;">Cancel Booking</x-button>
          </form>
